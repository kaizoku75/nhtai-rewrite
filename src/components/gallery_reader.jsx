...
class GalleryReader extends Component {
    ...
    computeImageUrl() {
        ...
        return `https://i.bakaa.me/galleries/${this.state.media_id}/${this.state.page}.${image_type[this_type]}`;
    }
    ...
    render() {
        ...
        return (
            <div class="container" id="page-container" onKeyDown={this.onKeyDown} tabIndex="0">
                <Helmet>
                    <title>{`${this.state.title} » nHtai`}</title>
                </Helmet>
                <section class="pagination" id="pagination-page-top">
                <a href={this.onLeftClick}onClick={this.onLeftClick} class="next"><i class="fa fa-chevron-left"></i></a><button className="page-number btn btn-unstyled"><span class="current">{this.state.page}</span> <span class="divider">of</span> <span class="num-pages">{this.state.images.length}</span></button><a href={this.onRightClick} onClick={this.onRightClick} class="next"><i class="fa fa-chevron-right"></i></a>
                </section>
                ...
                </div><section class="pagination" id="pagination-page-bottom">
                <a href={this.onLeftClick} onClick={this.onLeftClick} class="next"><i class="fa fa-chevron-left"></i></a><button className="page-number btn btn-unstyled"><span class="current">{this.state.page}</span> <span class="divider">of</span> <span class="num-pages">{this.state.images.length}</span></button><a href={this.onRightClick} onClick={this.onRightClick} class="next"><i class="fa fa-chevron-right"></i></a>
                </section>
                </div>
        );

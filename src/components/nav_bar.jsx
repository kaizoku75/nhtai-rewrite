 ...
 componentDidMount(){
    ...
    return (
        <nav role="navigation">
            ...
            <SearchBar />
                    <button type="button" class="btn btn-secondary btn-square" id="hamburger"><span class="line"></span><span class="line"></span><span class="line"></span></button><div class="collapse"><ul class="menu left"><li class="desktop "><a href="https://random.nhent.ai">Random</a></li><li class="desktop "><a href="/partner/">Partner</a></li><li class="desktop "><a href="/app/">App</a></li><li class="dropdown"><button class="btn btn-secondary btn-square" type="button" id="dropdown"><i class="fa fa-chevron-down"></i></button><ul class="dropdown-menu"><li><a href="https://random.nhent.ai/">Random</a></li><li><a href="/partner/">Partner</a></li><li><a href="/app/">App</a></li></ul></li></ul></div>
        </nav>
    )
   }
}
